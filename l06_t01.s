...
sub     sp, sp, #8
stmfd   sp!, {r1-r5} 
ldr     r1, [fp, #4]    // get address of first 
ldr     r2, [fp, #8]    // get address of second
ldr     r3, [fp, #12]    // get address of second
//=======================================================
...
add     sp, sp, #8      // remove local storage
